...
export const FiverrIcon: React.FC<{ className?: string }> = ({ className = "h-6 w-6" }) => (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      <path d="M19.16 7.42h-3.32v-.88c0-.6.02-1.3.05-1.8H14.2v4.73h-1.95V4.74H9.49c.83 2.36 2.1 4.42 3.71 5.99l-2.8 9.34h2.1l1.48-5.44h2.72l-1.53 5.44h2.1l4.01-13.4c.25-.83.38-1.68.38-2.52.01-.92-.15-1.72-.46-2.44.69.25 1.3.64 1.82 1.16.6.6.9 1.32 1.25 2.14h-2.18v.01z"/>
    </svg>
);
...
export const BehanceIcon: React.FC<{ className?: string }> = ({ className = "h-6 w-6" }) => (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path d="M8.23 11.18h3.9c.77 0 1.15-.39 1.15-1.1s-.38-1.08-1.15-1.08h-3.9v2.18zm0 3.6h4.15c.89 0 1.3-.43 1.3-1.25s-.41-1.25-1.3-1.25H8.23v2.5zm10.15-3.66c-.4-.25-.9-.39-1.52-.39-1.7 0-2.82 1.1-2.82 3.05 0 2.03 1.19 2.99 2.77 2.99 1.29 0 2.16-.54 2.16-.54l-.37-.9s-.76.43-1.51.43c-.74 0-1.3-.47-1.3-1.5h3.25c.04-2.6-1.18-4.72-3.8-4.72-2.5 0-4.4 1.7-4.4 4.78 0 3.08 1.88 4.79 4.4 4.79 1.7 0 3.1-.7 3.1-.7l.4 1s-1.6.9-3.5.9c-3.1 0-5.1-2-5.1-5.7s2.1-5.7 5.2-5.7c1.4 0 2.4.4 2.4.4l-.4 1.2zM17.18 12.83h-2.53c.08-.7.45-1.19 1.22-1.19.7 0 1.2.28 1.31.8v1.39zM15 8.25h-2.35v3.5H15V8.25z"/>
    </svg>
);

export const PenToolIcon: React.FC<{ className?: string }> = ({ className = "h-8 w-8" }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />
    </svg>
);

export const PaintBrushIcon: React.FC<{ className?: string }> = ({ className = "h-8 w-8" }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export const TagIcon: React.FC<{ className?: string }> = ({ className = "h-8 w-8" }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" />
    </svg>
);

export const SparklesIcon: React.FC<{ className?: string }> = ({ className = "h-8 w-8" }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
